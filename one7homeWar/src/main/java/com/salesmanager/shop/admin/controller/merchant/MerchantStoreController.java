...
public class MerchantStoreController {
	...
	public MerchantStoreResponse getMerchantStore() {
		...
		try {
			...
			merchantStoreResponse.setAddress(merchants.getStoreaddress());
			merchantStoreResponse.setCity(merchants.getStorecity());
			merchantStoreResponse.setCountry(merchants.getStorecity());
			merchantStoreResponse.setPostalCode(merchants.getStorepostalcode());
			merchantStoreResponse.setState(merchants.getStorepostalcode());
