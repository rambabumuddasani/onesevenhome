					    ...
					    <tbody>
							<tr>
								<td style="color:#333333; padding:16px 45px 0px; fomnt-family:Arial,sans-serif;" align="left">
									...
									<p style="color:333;font-size:12px;line-height:15px;margin:10px 0 10px 0;">Thank you for booking ${EMAIL_SERVICE_TYPE} offered by www.onesevenhome.com</p>
									<p style="color:333;font-size:12px;line-height:15px;margin:10px 0 10px 0;"><b>${ADMIN_VENDOR_BOOKING_COMMENT}</b></p>
								</td>
							</tr>
					    </tbody>
				    </table>
