					    ...
					    <tbody>
							<tr>
								<td style="color:#333333; padding:16px 45px 0px; fomnt-family:Arial,sans-serif;" align="left">
									...
									<p style="color:333;font-size:12px;line-height:15px;margin:10px 0 10px 0;">Your request for <b>${EMAIL_SERVICE_TYPE}</b> is registered and our vendor will be contacting you on the registered mobile number shortly.</p>
								</td>
							</tr>
					    </tbody>
				    </table>
