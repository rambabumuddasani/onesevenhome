					    ...
					    <tbody>
							<tr>
								<td style="color:#333333; padding:16px 45px 0px; fomnt-family:Arial,sans-serif;" align="left">
									...
									<p style="color:333;font-size:12px;line-height:15px;">Thank you for registering with OneSevenHome. Your registration request is awaiting for admin approval.
									</p>
								</td>
							</tr>
